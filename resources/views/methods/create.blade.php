...
<div class="card">
    ...
    <div class="card-content">
        ...
        <div class="form-group">
            ...
            <textarea name="exemple-1" id="exemple-1" class="form-control @error('exemple-1') is-invalid @enderror"
                placeholder="Proposez un exemple de code" aria-describedby="helpId" value="{{ old('exemple-1') }}">
                    </textarea>
        ...
        <div class="form-group">
            ...
            <textarea name="exemple-2" id="exemple-2" class="form-control @error('exemple-2') is-invalid @enderror"
                placeholder="Proposez un exemple de code" aria-describedby="helpId" value="{{ old('exemple-2') }}">
                    </textarea>
            <small id="helpId" class="text-muted">Donner un exemple de code pour illustrer la méthode en
                cours</small>
            @error('exemple-2')
        ...
        <div class="form-group">
            ...
            <textarea name="exemple-3" id="exemple-3" class="form-control @error('exemple-3') is-invalid @enderror"
                placeholder="Proposez un exemple de code" aria-describedby="helpId" value="{{ old('exemple-3') }}">
                    </textarea>
            <small id="helpId" class="text-muted">Donner un exemple de code pour illustrer la méthode en
                cours</small>
            @error('exemple-3')
        ...
        <button class="btn btn-warning my-4" type="button" data-toggle="collapse" data-target="#otherSourcesCode"
            aria-expanded="false" aria-controls="otherSourcesCode">Ajouter
