...
@component('components/sourcecode')dump($languages->contains('C'));@endcomponent
@php
...
@component('components/sourcecode')dump($complexe->contains('ref', 'XZ42'));@endcomponent
@php
dump($complexe->contains('ref', 'XZ42'));
@endphp

<h1>Key search 'price',''</h1>
@component('components/sourcecode')dump($complexe->contains('price', ''));@endcomponent
@php
dump($complexe->contains('price', ''));
@endphp

<h1>Contains with callback method</h1>
@component('components/sourcecode')dump($numbers->contains(function ($value, $key){
